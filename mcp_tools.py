...
TOOLS = [
    {
        ...
        "desc": "Full-text search over name, description, owner, also-known-as, repo URL "
                "and the proprietary products each replaces, with optional facet filters. Every "
                "filter is AND-ed.",
    },
    {
